...
def create_model(input_shape, seed, num_filters, model_type='physical'):
    ...
    if model_type == 'physical':
        hydro_output= PRNN_NeuralODE_v1(h_nodes=128,mode='normal', seed = seed , name= 'Hydro')(x_input)
...
save_path_physical = f'{working_path}/results/local_prnn_neuralode_models/local_{basin_id}.h5'
